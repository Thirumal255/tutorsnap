...
export const updateTaskExpense     = (taskId, expId, data) => api.put(`/admin/tasks/${taskId}/expenses/${expId}`, data)

// Finance (3-tier fund flow + bank/cash balances)
export const getFinanceSummary     = ()       => api.get('/admin/finance/summary')
export const getFinanceAccounts    = ()       => api.get('/admin/finance/accounts')
export const createFinanceAccount  = (data)   => api.post('/admin/finance/accounts', data)
export const updateFinanceAccount  = (id, d)  => api.put(`/admin/finance/accounts/${id}`, d)
export const deleteFinanceAccount  = (id)     => api.delete(`/admin/finance/accounts/${id}`)
export const getFinanceSources     = ()       => api.get('/admin/finance/sources')
export const createFinanceSource   = (data)   => api.post('/admin/finance/sources', data)
export const updateFinanceSource   = (id, d)  => api.put(`/admin/finance/sources/${id}`, d)
export const deleteFinanceSource   = (id)     => api.delete(`/admin/finance/sources/${id}`)
export const getFinanceReceipts    = ()       => api.get('/admin/finance/receipts')
export const createFinanceReceipt  = (data)   => api.post('/admin/finance/receipts', data)
export const updateFinanceReceipt  = (id, d)  => api.put(`/admin/finance/receipts/${id}`, d)
export const deleteFinanceReceipt  = (id)     => api.delete(`/admin/finance/receipts/${id}`)
export const getFinanceAllocations = ()       => api.get('/admin/finance/allocations')
export const createFinanceAlloc    = (data)   => api.post('/admin/finance/allocations', data)
export const updateFinanceAlloc    = (id, d)  => api.put(`/admin/finance/allocations/${id}`, d)
export const deleteFinanceAlloc    = (id)     => api.delete(`/admin/finance/allocations/${id}`)
