  ...
  return (
    <div className="p-8 max-w-3xl space-y-6">
      ...
      <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-6">
        <h3 className="text-sm font-semibold text-gray-700 mb-4">Upload Textbook PDF</h3>
        <div className="flex flex-col sm:flex-row gap-3 items-start">
          ...
          <button
            ...
            className="px-5 py-2 bg-green-600 text-white rounded-lg font-medium text-sm hover:bg-green-700 disabled:opacity-50 disabled:cursor-not-allowed"
          >
          ...
          {status === 'done' && bookData && (
            <div className="flex items-center gap-2 text-green-700">
              ...
              <span className="font-medium">
                {bookData.chapter_count} chapters and {bookData.topic_count} topics extracted.
              </span>
            </div>
          )}
          {status === 'failed' && (
      ...
      {topicsData && (
        <div className="space-y-3">
          <h3 className="text-base font-semibold text-gray-700">Extracted Topics</h3>
