...
def upgrade() -> None:
    ...
    op.add_column('session_turns', sa.Column('answer_format', sa.String(length=30), nullable=True))
    op.add_column('session_turns', sa.Column('missed_key_points', sa.Text(), nullable=True))
    op.add_column('sessions', sa.Column('level_question_count', sa.Integer(), nullable=True, server_default='0'))
